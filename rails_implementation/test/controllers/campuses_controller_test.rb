...
class CampusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campus" do
    assert_difference('Campus.count') do
      post campuses_url, params: { campus: { address: @campus.address, code: @campus.code, name: @campus.name } }
    end
  ...
  test "should update campus" do
    patch campus_url(@campus), params: { campus: { address: @campus.address, code: @campus.code, name: @campus.name } }
